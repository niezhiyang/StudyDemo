...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TAG = "SoDemo";
    ...
    protected void onStart() {
        ...
        startLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e(MainActivity.TAG,"path---"+property+"---classPath： "+classPath+"---librarySearchPath： "+librarySearchPath);
                if (startLocation.getText().toString().equals("开始")) {
                    locationService.start();// 定位SDK
                    // start之后会默认发起一次定位请求，开发者无须判断isstart并主动调用request
                    startLocation.setText("停止");
                } else {
                    locationService.stop();
                    startLocation.setText("开始");
                }
            }
        });
    }
